...
![](assets/web-application-20250605165227-4l1w84w.png)
...
![](assets/django_request_response_cycle-20250605165227-867lnaa.png)
...
![](assets/mvc-20250605165227-mu87i71.png)

### HTTP请求和响应

#### HTTP请求 = 请求行+请求头+空行+[消息体]

![](assets/http-request-20250605165227-215k9w0.png)

#### HTTP响应 = 响应行+响应头+空行+消息体

![](assets/http-response-20250605165227-1hgi3xz.png)
...
5. XFrameOptionsMiddleware - 防范点击劫持攻击中间件
   ...
   ![](assets/click-jacking-20250605165227-ur9c370.png)

![](assets/builtin-middlewares-20250605165227-b2kmx8i.png)
...
1. RBAC - 基于角色的访问控制，如下图所示。
   ...
   ![](assets/rbac-basic-20250605165227-fxuhmqi.png)

   ![](assets/rbac-full-20250605165227-w9n9oq6.png)
...
![](assets/celery_architecture-20250605165227-5h2l34t.png)
...
- Selenium IDE：嵌入到浏览器的插件，可以录制和回放脚本。
  ...
  ![](assets/selenium_ide-20250605165227-31cj147.png)
...
请参考[《项目部署上线和性能调优》](assets/98.项目部署上线和性能调优-20250605165225-kztggm2.md)。
