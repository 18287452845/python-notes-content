...
![](assets/git-logo-20250605165227-vvksgkj.png)
...
![](assets/git_repository-20250605165227-0wohsi7.png)
...
![](assets/gitlab-about-20250605165227-c5128oz.png)
...
1. 创建项目时不建议勾选如下图所示的这些选项，编程语言可以暂时不做选择，而`.gitignore`模板也可以稍后自己编写或者通过更专业的工具（如：[http://gitignore.io/](http://gitignore.io/)网站）自动生成。
   ...
   ![](assets/gitee-create-project-20250605165227-gvy5hin.png)
2. 添加项目成员。创建项目后，可以在项目的“设置”或“管理”中找到“成员管理”功能，这样就可以将其他开发者设置为项目团队的成员，项目成员通常分为“所有者”、“管理者”、“普通成员”和“受限成员”几种角色。

   ![](assets/gitee-add-members-20250605165227-yd34pwb.png)
...
![](assets/gitee-project-index-20250605165227-poe34wr.png)
...
4. 分支**变基**。分支合并操作可以将多个分支上的工作成果最终合并到一个分支上，但是再多次合并操作之后，分支可能会变得非常的混乱和复杂，为了解决这个问题，可以使用`git rebase`操作来实现分支变基。如下图所示，当我们希望将`master`和`dev`上的工作成果统一到一起的时候，也可以使用变基操作。
   ...
   ![](assets/git-rebase-20250605165227-nf22do9.png)
...
4. `git reset`：回退到指定的版本。该命令主要有三个参数，如下图所示。
   ...
   ![](assets/git-reset-20250605165227-v8mmwt1.png)
...
5. 在线发起一次合并请求（通常称之为**Pull Request**，有的地方称为**Merge Request**），请求将自己的工作成果合并到`master`分支，合并之后可以删除该分支。
   ...
   ![](assets/gitee-pull-request-20250605165227-s29pxy6.png)
...
![](assets/git-flow-20250605165227-chhugam.png)
...
![](assets/git-flow-detail-20250605165227-w7ubnz3.png)
...
![](assets/gitlab-new-issue-20250605165227-54y4dur.png)
...
![](assets/jenkins_new_project-20250605165227-63e7e29.png)
