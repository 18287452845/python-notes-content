...
4. ER模型（实体关系模型）和概念模型图。
   ...
   **ER模型**，全称为**实体关系模型**（Entity-Relationship Model），由美籍华裔计算机科学家陈品山先生提出，是概念数据模型的高层描述方式，如下图所示。
   ...
   ![](assets/er_diagram-20250605165224-vfozj5n.png)
   ...
   ![](assets/conceptual_model-20250605165224-23blnsy.png)
5. 关系数据库产品。
...
1. 通过[官方网站](https://www.mysql.com/)提供的[下载链接](https://dev.mysql.com/downloads/windows/installer/8.0.html)下载“MySQL社区版服务器”安装程序，如下图所示，建议大家下载离线安装版的MySQL Installer。
   ...
   ![](assets/20211105230905-20250605165224-mis2b74.png)
2. 运行 Installer，按照下面的步骤进行安装。

   - 选择自定义安装。

   ![](assets/20211105231152-20250605165224-byl50tx.jpg)

   - 选择需要安装的组件。

   ![](assets/20211105231255-20250605165224-qgcjerr.jpg)

   - 如果缺少依赖项，需要先安装依赖项。

   ![](assets/20211105231620-20250605165224-iaid3kh.png)

   - 准备开始安装。

   ![](assets/20211105231719-20250605165224-ajgghjt.jpg)

   - 安装完成。

   ![](assets/20211105232024-20250605165224-zjnpvfc.jpg)

   - 准备执行配置向导。

   ![](assets/20211105231815-20250605165224-lz0fu2w.jpg)
3. 执行安装后的配置向导。

   - 配置服务器类型和网络。

   ![](assets/20211105232109-20250605165224-7yukzsx.jpg)

   - 配置认证方法（保护密码的方式）。

     ![](assets/20211105232408-20250605165224-7kqkeds.jpg)
   - 配置用户和角色。

     ![](assets/20211105232521-20250605165224-kv2uu6e.jpg)
   - 配置Windows服务名以及是否开机自启。

     ![](assets/20211105232608-20250605165224-a1oz0ms.jpg)
   - 配置日志。

     ![](assets/20211105232641-20250605165224-umiy7sb.jpg)
   - 配置高级选项。

     ![ACAC15B8633133B65476286A49BFBD7E](assets/20211105232724-20250605165224-zcut2qv.jpg)
   - 应用配置。

     ![](assets/20211105232800-20250605165224-nqfc3yq.jpg)
4. 可以在 Windows 系统的“服务”窗口中启动或停止 MySQL。

   ![](assets/20211105232926-20250605165224-q2cwhl2.jpg)
5. 配置 PATH 环境变量，以便在命令行提示符窗口使用 MySQL 客户端工具。

   - 打开 Windows 的“系统”窗口并点击“高级系统设置”。

     ![](assets/20211105233054-20250605165225-v1u8bwv.jpg)
   - 在“系统属性”的“高级”窗口，点击“环境变量”按钮。

     ![](assets/20211105233312-20250605165225-bpqzint.jpg)
   - 修改PATH环境变量，将MySQL安装路径下的`bin`文件夹的路径配置到PATH环境变量中。

     ![](assets/20211105233359-20250605165225-0sjcpcf.jpg)
   - 配置完成后，可以尝试在“命令提示符”下使用 MySQL 的命令行工具。

     ![](assets/20211105233643-20250605165225-dh7an4p.jpg)
