...
![](assets/web-application-20250605165225-bng4u9v.png)
...
![](assets/http-request-20250605165225-h1mtm6t.png)

HTTP响应（响应行+响应头+空行+消息体）：

![](assets/http-response-20250605165225-70a4s3u.png)
...
![](assets/mvc-20250605165225-fgqrb06.png)
...
4. 用PyCharm打开创建好的Djang项目，并为其添加虚拟环境。
   ...
   ![](assets/pycharm-django-project-20250605165225-tysb45k.png)
   ...
   > 说明：WSGI全称是Web服务器网关接口，维基百科上给出的解释是“为Python语言定义的[Web服务器](https://zh.wikipedia.org/wiki/網頁伺服器)和[Web应用程序](https://zh.wikipedia.org/wiki/网络应用程序)或框架之间的一种简单而通用的接口”。
   >

   创建虚拟环境的界面如下图所示。

   ![pycharm-django-virtual-environment](assets/pycharm-django-virtual-environment-20250605165225-u2l1qrt.png)
5. 安装项目依赖项。
   ...
   ![](assets/pycharm-install-django-20250605165225-8wcuoaj.png)
...
6. 启动Django自带的服务器运行项目。
   ...
   ![](assets/pycharm-django-server-20250605165225-c4swhfm.png)

   方法二：在“Run”菜单选择“Edit Configuration”，配置运行“Python”程序运行项目（适用于专业版和社区版PyCharm）。

   ![](assets/pycharm-python-manage-20250605165225-r1rar68.png)
...
![](assets/django-index-1-20250605165225-447mer4.png)
...
8. 修改项目的配置文件`settings.py`。
   ...
   ![](assets/django-index-2-20250605165225-gaguxn6.png)
...
1. 在项目目录下创建名为templates文件夹。
   ...
   ![](assets/pycharm-django-template-20250605165225-zlqr1h9.png)
2. 添加模板页`index.html`。
