...
- 渐近时间复杂度的大O标记：
  ...
  - ![](http://latex.codecogs.com/gif.latex?O(c))
     - 常量时间复杂度 - 布隆过滤器 / 哈希存储
  - ![](http://latex.codecogs.com/gif.latex?O(log_2n))
     - 对数时间复杂度 - 折半查找（二分查找）
  - ![](http://latex.codecogs.com/gif.latex?O(n))
     - 线性时间复杂度 - 顺序查找 / 计数排序
  - ![](http://latex.codecogs.com/gif.latex?O(n*log_2n))
  ...
  ![](assets/algorithm_complexity_1-20250605165224-jug6yl9.png)

  ![](assets/algorithm_complexity_2-20250605165224-ng3v92a.png)
