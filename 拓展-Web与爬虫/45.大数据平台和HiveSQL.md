...
![](assets/sql_to_mr-20250605165225-73r9fzf.png)

![](assets/HADOOP-ECOSYSTEM-Edureka-20250605165225-aegjg2q.png)
...
![](assets/what_hive_can_do-20250605165225-uvkj4tv.png)

![](assets/what_hive_can_not_do-20250605165225-w4z5u6h.png)

Hive和传统关系型数据库的对比如下图和下表所示。

![](assets/hive_vs_rdbms-20250605165225-2bip38w.png)
...
1. 搭建如下图所示的大数据平台。
   ...
   ![](assets/20220210080638-20250605165225-8xa2gs2.png)
2. 通过Client节点（跳板机）访问大数据平台。

   ![](assets/20220210080655-20250605165225-fkqv6sl.png)
3. 创建文件Hadoop的文件系统。
...
![](assets/hive_data_types-20250605165225-rqapmzk.png)
