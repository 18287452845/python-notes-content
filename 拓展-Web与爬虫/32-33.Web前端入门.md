...
> **说明**：本文使用的部分插图来自 *Jon Duckett* 的*[HTML and CSS: Design and Build Websites](https://www.amazon.cn/dp/1118008189/ref=sr_1_5?__mk_zh_CN=亚马逊网站&keywords=html+&+css&qid=1554609325&s=gateway&sr=8-5)*一书，这是一本非常棒的前端入门书，有兴趣的读者可以在亚马逊或者其他网站上找到该书的购买链接。
...
- 图像存储位置
  ...
  ![](assets/相对路径-20250605165224-hzqu5ys.png)
- 图像及其宽高
- 选择正确的图像格式
...
- 字符实体（实体替换符）
  ...
  ![](assets/字符实体-20250605165224-tiiu0z4.png)
...
- 规则、属性和值
  ...
  ![](assets/选择器语法-20250605165224-4f5r11f.png)
- 常用选择器

  ![](assets/常用选择器-20250605165224-i6vi6hx.png)
...
- 文本的大小和字型(font-size / font-family)
  ...
  ![](assets/尺寸单位-20250605165224-1hthtgx.png)

  ![](assets/衬线字体+非衬线字体+等宽字体-20250605165224-8bjf85s.png)
- 粗细、样式、拉伸和装饰(font-weight / font-style / font-stretch / text-decoration)

  ![](assets/字体样式-20250605165224-dotcgmo.png)
...
- 盒子的边框、外边距和内边距（border /  margin / padding）
  ...
  ![](assets/盒子模型-20250605165224-rtua4ys.png)
...
- 网站布局
  ...
  - HTML5布局
    ...
    ![](assets/经典布局-2-20250605165224-pl0unkl.png)
- 适配屏幕尺寸
...
![](assets/baidu_echarts-20250605165224-pcfc71c.png)
...
3. 可视化
   ...
   ![](assets/bootstrap-layoutit-20250605165224-644we3l.png)
