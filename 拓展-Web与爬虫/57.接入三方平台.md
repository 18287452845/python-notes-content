...
3. 点击“触发发送”可以找到自己专属的API Key（身份标识）。
   ...
   ![](assets/luosimao-sms-apikey-20250605165225-n61rygy.png)
4. 点击“签名管理”可以添加短信签名，短信都必须携带签名，免费试用的短信要在短信中添加“【铁壳测试】”这个签名，否则短信无法发送。

   ![](assets/luosimao-sms-signature-20250605165225-6jo297z.png)
5. 点击“IP白名单”将运行Django项目的服务器地址（公网IP地址，本地运行可以打开[xxx]()网站查看自己本机的公网IP地址）填写到白名单中，否则短信无法发送。

   ![](assets/luosimao-sms-whitelist-20250605165225-o9yrpal.png)
6. 如果没有剩余的短信条数，可以到“充值”页面选择“短信服务”进行充值。

   ![](assets/luosimao-pay-onlinebuy-20250605165225-0vot59t.png)
...
1. 注册账号，登录管理控制台。
   ...
   ![](assets/qiniu-manage-console-20250605165225-j90yjgx.png)
2. 选择左侧菜单中的对象存储。

   ![](assets/qiniu-storage-service-20250605165225-bfkh9wi.png)
...
![](assets/qiniu-file-management-20250605165225-se29r2l.png)
