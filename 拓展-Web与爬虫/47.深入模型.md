...
![](assets/pycharm-vote-project-20250605165225-t3tc0bo.png)
...
3. 运行项目，在浏览器中访问`http://127.0.0.1:8000/admin`，输入刚才创建的超级用户账号和密码进行登录。
   ...
   ![](assets/django-admin-apps-20250605165225-l56qrqh.png)
...
4. 注册模型类。
   ...
   ![](assets/django-admin-models-20250605165225-slp5102.png)
5. 对模型进行CRUD操作。
   ...
   - 添加学科。
     ...
     ![](assets/django-admin-add-model-20250605165225-blnxu3x.png)
   - 查看所有学科。

     ![](assets/django-admin-view-models-20250605165225-rg601xc.png)
   - 删除和更新学科。

     ![](assets/django-admin-delete-update-model-20250605165225-7gbanum.png)
6. 注册模型管理类。
   ...
   ![](assets/django-admin-view-models-subject-20250605165225-31bjswf.png)

   ![](assets/django-admin-view-models-teacher-20250605165225-mrhwcw0.png)
